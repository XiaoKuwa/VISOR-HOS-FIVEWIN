...
if __name__ == "__main__":
    ...
    os.rename("./checkpoints/handside/inference/instances_predictions.pth", "./checkpoints/handside/inference/instances_predictions_handside.pth")
    os.rename("./checkpoints/handside/inference/coco_instances_results.json", "./checkpoints/handside/inference/coco_instances_results_handside.json")