...
if __name__ == "__main__":
    ...
    os.rename("./checkpoints/hos/inference/instances_predictions.pth", "./checkpoints/hos/inference/instances_predictions_hand_obj.pth")
    os.rename("./checkpoints/hos/inference/coco_instances_results.json", "./checkpoints/hos/inference/coco_instances_results_hand_obj.json")