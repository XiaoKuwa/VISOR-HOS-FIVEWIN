...
register_epick_instances("epick_visor_2022_val_hos", {}, "./testjson/testnewhos.json", f"{version}/test")
...
register_epick_instances("epick_visor_2022_val_contact", {}, "./testjson/testnewcontact.json", f"{version}/test")
...
register_epick_instances("epick_visor_2022_val_handside", {}, "./testjson/testnewhandside.json", f"{version}/test")
MetadataCatalog.get("epick_visor_2022_val_handside").thing_classes = ["left", "right"]

version = 'datasets/epick_visor_coco_active'
register_epick_instances("epick_visor_2022_val_active", {}, f"{version}/annotations/testnew.json", f"{version}/test")
MetadataCatalog.get("epick_visor_2022_val_active").thing_classes = ["hand", "object"]

version = 'datasets/epick_visor_coco_combineHO'
register_epick_instances("epick_visor_2022_val_combineHO", {}, "./testjson/testnewcombineHO.json", f"{version}/test")
...
if __name__ == "__main__":
    ...
    os.rename("./checkpoints/combineHO/inference/instances_predictions.pth", "./checkpoints/combineHO/inference/instances_predictions_combineHO.pth")
    os.rename("./checkpoints/combineHO/inference/coco_instances_results.json", "./checkpoints/combineHO/inference/coco_instances_results_combineHO.json")