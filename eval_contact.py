...
if __name__ == "__main__":
    ...
    os.rename("./checkpoints/contact/inference/instances_predictions.pth", "./checkpoints/contact/inference/instances_predictions_contact.pth")
    os.rename("./checkpoints/contact/inference/coco_instances_results.json", "./checkpoints/contact/inference/coco_instances_results_contact.json")